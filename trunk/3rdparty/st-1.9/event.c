...
ST_HIDDEN void _st_select_find_bad_fd(void)
{
    ...
    _st_pollq_t *pq = NULL;
    int notify = 0;
    struct pollfd *pds = NULL, *epds = NULL;
    int pq_max_osfd = -1, osfd = -1;
    short events = 0;
...
{
    struct timeval timeout = {0, 0}, *tvp = NULL;
    fd_set r, w, e;
    fd_set *rp = NULL, *wp = NULL, *ep = NULL;
    int nfd = -1, pq_max_osfd = -1, osfd = -1;
    _st_clist_t *q = NULL;
    st_utime_t min_timeout = 0;
    _st_pollq_t *pq = NULL;
    int notify = 0;
    struct pollfd *pds = NULL, *epds = NULL;
    short events = 0, revents = 0;
...
ST_HIDDEN void _st_poll_dispatch(void)
{
    ...
    st_utime_t min_timeout = 0;
    _st_pollq_t *pq = NULL;
    struct pollfd *pds = NULL, *epds = NULL, *pollfds = NULL;
...
{
    struct timespec timeout = {0, 0}, *tsp = NULL;
    struct kevent kev;
    st_utime_t min_timeout = 0;
    _st_clist_t *q = NULL;
    _st_pollq_t *pq = NULL;
    struct pollfd *pds = NULL, *epds = NULL;
    int nfd = 0, i = 0, osfd = 0, notify = 0, filter = 0;
    short events = 0, revents = 0;
	memset(&kev, 0, sizeof(struct kevent));
    if (_ST_SLEEPQ == NULL) {
        tsp = NULL;
...
ST_HIDDEN int _st_epoll_pollset_add(struct pollfd *pds, int npds)
{
    struct epoll_event ev;
    int i = 0, fd = -1;
    int old_events = -1, events = -1, op = -1;
...
ST_HIDDEN void _st_epoll_dispatch(void)
{
    ...
    struct pollfd *pds = NULL, *epds = NULL;
    struct epoll_event ev;
    int timeout = 0, nfd = 0, i = 0, osfd = 0, notify = 0;
    int events = 0, op = 0;
    short revents = 0;
    memset(&min_timeout, 0, sizeof(min_timeout));
    if (_ST_SLEEPQ == NULL) {
        timeout = -1;
    } else {
        min_timeout = (_ST_SLEEPQ->due <= _ST_LAST_CLOCK) ? 0 :
