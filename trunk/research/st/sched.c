...
_st_thread_t *_st_this_thread = NULL;  /* Current thread */
int _st_active_count = 0;       /* Active thread count */

time_t _st_curr_time = 0;       /* Current time as returned by time(2) */
st_utime_t _st_last_tset = 0;       /* Last time it was fetched */
...
static void heap_delete(_st_thread_t *trd) 
{
    ...
    *p = NULL;
    ...
    if (t != trd) {
        ...
        */
        for (;;) {
            _st_thread_t *y = NULL; /* The younger child */
            int index_tmp = 0;
